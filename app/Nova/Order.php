    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Location', function ($order) {
                ...
                $text = "
                <p> Address : <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_inline_address</span></p>
                <p>Zip Code : <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_postal_code</span></p>
                <p>Shipping Street: <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_street</span></p>
                <p>Shipping barangay: <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_barangay</span></p>
                <p>Shipping city: <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_city</span></p>
                <p>Shipping Subdivision/bldg: <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_building</span></p>
                <p>Shipping House/Flr Number: <span class='px-2 text-sm font-bold bg-blue-200 text-gray-900 rounded-3xl'>$location->shipping_house_number</span></p>";
