<div class="h-20 bg-green-200 relative">
    <form action="{{route('search')}}" class="mx-auto md:w-1/2 md:left-1/4 w-full p-2 absolute -top-6">
        <input type="text" name="keyword" required id="_search_bar" class="w-full p-3 rounded-full focus:bg-green-200 focus:outline-none">
        <button class="absolute right-3 top-3 bg-pink-600 w-10 h-10 text-white rounded-full">
    ...
    <div class="absolute bottom-3 w-full">
        <div class="text-center flex justify-start md:justify-center overflow-y-auto items-center">
            ...
            <a href="/discount/{{$discount->id}}" class="text-xs uppercase p-1 px-2 bg-pink-600 text-white rounded-full cursor-pointer mx-2 border-2 border-white flex-none">
